                    ...
                    <SubmitForm onSubmit={onSubmit} ref={formRef}>
                        <TextContainer>
                            <Text size="large" color={theme.textSecondary} align="center">
                                Choose your settings for the Voting and Dot Voting apps below. You can’t change the support required later, so pick carefully.
                            </Text>
                        </TextContainer>
                        <Fields>
                        ...
                        <TextContainer>
                            <Text size="xsmall" color={theme.textSecondary} align="left">
                                ...
                                <StrongSafeLink href={TPS_GUIDE} target="_blank">
                                    Find out more
                                </StrongSafeLink>{' '}
